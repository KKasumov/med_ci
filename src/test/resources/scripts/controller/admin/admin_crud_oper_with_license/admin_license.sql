...
VALUES (77, 'Employee', 'hr@mail.ru', '$2a$12$9yMn07D/9xofijwJdmrCHeFHN4wMieItyUmGlGS2V4W3MYq16fl/K', '777-777-777 777', 'Ivan', 'Ivanov', 'Ivanovich', '1970-01-01', 'MALE', true, 800),
...
VALUES(119, 'code119', 'ГБУЗ Пензенский областной клинический центр специализированных видов медицинской помощи', 'address119', 'ogrn119', '1990-01-01', '2030-01-01', 13.5, 19, 19);
INSERT INTO medical_organization(id, code, name, legal_address, ogrn, start_date, end_date, full_employment_status_range, director_id, io_director_id)
VALUES(116, 'code116', 'ГБУЗ Пензенская областная клиническая больница им. Н.Н. Бурденко', 'address116', 'ogrn116', '1990-01-01', '2030-01-01', 13.5, 16, 17);
INSERT INTO medical_organization(id, code, name, legal_address, ogrn, start_date, end_date, full_employment_status_range, director_id, io_director_id)
VALUES(117, 'code117', 'name117', 'address117', 'ogrn117', '1990-01-01', '2030-01-01', 13.5, 18, 17);

INSERT INTO license(id, name, number, date_from, date_to, medical_organization_id)
VALUES (196, 'Лицензия на осуществление врачебной деятельности', '3141541', '1990-01-01', '2035-01-01', 119);
INSERT INTO license(id, name, number, date_from, date_to, medical_organization_id)
VALUES (197, 'Лицензия на пользование WINDOW12', '7567446', '2010-01-01', '2024-01-01', 119);
INSERT INTO license(id, name, number, date_from, date_to, medical_organization_id)
VALUES (198, 'Лицензия на пользование туалета', '12585457', '2020-01-01', '2028-01-01', 119);
...
VALUES (160, '2010-01-01', '2024-09-02', 1.0, 130, 100, 30),
       (161, '2010-01-01', '2020-08-10', 1.0, 131, 101, 31),
       (162, '2010-01-01', '2023-05-24', 1.0, 132, 101, 32),
       (163, '2010-01-01', '2024-03-09', 1.0, 133, 102, 33),
       (164, '2010-01-01', '2030-07-11', 1.0, 134, 100, 34);