...
VALUES (60, 'Инфекционное отделение', 'ADULT', 116),
       (61, 'Хирургическое отделение', 'ADULT', 117),
       (62, 'ГБУЗ Клиническая больница №5', 'ADULT', 119);
...
VALUES (100, 'Терапевт', 42, 61),
       (101, 'Хирург', 42, 61),
       (102, 'Офтальмолог', 42, 61);
