...
INSERT INTO users (id, dtype, email, password, snils, first_name, last_name, patronymic, birthday, gender, is_enabled,
                   role_id)
VALUES (10, 'Employee', 'gena@mail.com', '$2a$12$bne09gQ3iWNENHOWNgFji.3H7XBqcBHv./xqulIbPs0lOntYUGSg.', '000-000-000 03', 'Gennady', 'Gennadyev', 'Gennadyevich', '1998-01-07', 'MALE', true, 100),
...
VALUES (12, 'Первое детское отделение', 'CHILD', 20, null, 1),
...
VALUES (10, '2018-06-13', null, 0.5, 8, 1, 1 );