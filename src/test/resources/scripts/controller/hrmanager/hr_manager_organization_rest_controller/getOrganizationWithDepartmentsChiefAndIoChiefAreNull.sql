...
VALUES (1, '1123', 'Инвитро', 'Chelyabinsk', '202-12', '2010-09-09', '2099-09-09', 223.75, null, null);

INSERT INTO department (id, name, age_type, chief_doctor_id, io_chief_doctor_id, medical_organization_id)
VALUES (1001, 'Первое детское отделение', 'CHILD', null, null, 1),
       (1002, 'Второе детское отделение', 'CHILD', null, null, 1),
       (1003, 'Первое взрослое отделение', 'ADULT', null, null, 1),
       (1004, 'Второе взрослое отделение', 'ADULT', null, null, 1);
