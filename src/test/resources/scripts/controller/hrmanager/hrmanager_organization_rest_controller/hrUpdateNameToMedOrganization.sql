...
VALUES(119, '32123', 'Государственное учреждение имени Важного человека', 'Omsk', '304500116000157', '1992-01-01', '2030-01-01', 18.5, 16, 16);

INSERT INTO department (id, name, medical_organization_id)
VALUES (60, 'department1', 119),
       (61, 'department1', 119);
...
VALUES (130, 'DoctorHistory', true, 12, 60),
       ...
       (132, 'DoctorHistory', true, 14, 60),
       (133, 'DoctorHistory', true, 16, 60),
       (134, 'DoctorHistory', true, 17, 61),
       (135, 'DoctorHistory', true, 18, 61),
