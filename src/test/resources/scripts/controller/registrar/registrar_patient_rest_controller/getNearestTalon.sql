...
INSERT INTO users (id, dtype, email, password, snils, first_name, last_name, patronymic, birthday, gender, is_enabled,
                   role_id)
VALUES (777, 'Employee', 'rg@mail.ru', '$2a$12$9yMn07D/9xofijwJdmrCHeFHN4wMieItyUmGlGS2V4W3MYq16fl/K',
        '777-777-777 777', 'Ivan', 'Ivanov', 'Ivanovich', '1970-01-01', 'MALE', true, 100),
       (19, 'Doctor', 'doc19@mail.com', '$2a$12$9yMn07D/9xofijwJdmrCHeFHN4wMieItyUmGlGS2V4W3MYq16fl/K', '019', 'doc19',
        'docov19', 'docovich19', '1990-01-01', 'MALE', true, 300),
       (17, 'Doctor', 'doc17@mail.com', '$2a$12$9yMn07D/9xofijwJdmrCHeFHN4wMieItyUmGlGS2V4W3MYq16fl/K', '017', 'doc17',
       ...
       (23, 'Patient', 'pat23@mail.com', '$2a$12$Qsizn.Wo0VjZM6kpaPyuYeULF0ppd1mND3389lQPChAbFMrGhpUdG', '023', 'pat23',
        'pat23', 'pat23', '1990-02-02', 'MALE', true, 200),
       (24, 'Patient', 'pat24@mail.com', '$2a$12$Qsizn.Wo0VjZM6kpaPyuYeULF0ppd1mND3389lQPChAbFMrGhpUdG', '024', 'pat24',
        'pat24', 'pat24', '1990-02-02', 'MALE', true, 200);
...
VALUES (65, 'department2', 'ADULT', 119),
       (66, 'department3', 'CHILD', 119);
...
VALUES (222, CAST(CURRENT_DATE AS TIMESTAMP) + INTERVAL '0 11:00:00', 1, 130),
       (224, CAST(CURRENT_DATE AS TIMESTAMP) + INTERVAL '0 15:00:00', 2, 130),
       (225, CURRENT_TIMESTAMP + INTERVAL '1 minute', null, 130),
       (223, CAST(CURRENT_DATE AS TIMESTAMP) + INTERVAL '0 20:00:00', null, 130);
